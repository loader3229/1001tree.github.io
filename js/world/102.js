    ...
    tabFormat:{
        clickwall:{
            content:[
                ...
                "blank",
                ["display-text", function () {
                    return hasMilestone("102",1) ? `里程碑2的效果为<h2 style="color:#a0a0a0;text-shadow:0 0 15px #a0a0a0"> ${format(layers[this.layer].m2effect())}</h2>x`:``
                }],
            ]
        },
        challenge:{
            content:[
                ...
                ["display-text", function () {
                    return `你完成的<h2 style="color:#a0a0a0;text-shadow:0 0 15px #a0a0a0"> ${formatWhole(layers[this.layer].chalcomp())} </h2>个挑战使得点击墙变为<h2 style="color:#a0a0a0;text-shadow:0 0 15px #a0a0a0"> ${format(layers[this.layer].chaleff())} </h2>次方！`
                }],
                ["display-text", function () {
        ...
        11:{
            ...
            onClick(){
                if(player._102.mode==1){
                    ...
                    if(hasMilestone("102",5)) player._102.divclick=player._102.divclick.sub(hasMilestone("102",7) ? 0.075 : 0.05)
