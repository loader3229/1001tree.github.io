...
//信息,初始数值,目标数值,目标显示表达式,目标是否需要显示近似值
const data402 = {
	0: ["看来出了点问题啊，你不应该看到这段文本的——请反馈给开发者",_D0,_D1,"1",false],
	1: ["在本世界里，你的目标是把给定的数值变为目标值。当前数值和目标值均在下方显示。",_D0,_D8,"8",false],
	2: ["坏消息：小明碰洒的墨水将按钮上的信息覆盖住了，因此你需要猜测每个按钮的功能。",_D0,_D3,"3",false],
	3: ["之后的目标会更加复杂，因此会显示表达式和近似值。注意近似值只会显示3位小数。",_D0,_D1,"1",false],
	4: ["由于无法插入公式，以后将用 '/' 代替分数线，例如本关的目标是负二分之一。",_D0,new Decimal(-0.5),"-1/2",true],
	5: ["静下心，思考一会儿……",_D0,new Decimal(1.75),"7/4",true],
	6: ["值得一提的是，初始数值并不一定是0。本关的初始数值是16。",new Decimal(16),_D0,"0",false],
	7: ["由于无法插入公式，以后将用 'sqrt()' 代替算术平方根，例如sqrt(2)就表示根号2。",_D0,new Decimal(3).sqrt(),"sqrt(3)",true],
	8: ["这是什么！？",_D0,new Decimal(NaN),"NaN",false],
	9: ["你可以达成黄金比例了！另外，你将在第10,20,30关分别获得1梦力。",_D0,_D5.sqrt().sub(1).div(2),"[sqrt(5)-1]/2",true],
	10: ["恭喜迎来第一个boss关！",_D0,_D3.sqrt().add(_D2.sqrt()).div(2),"[sqrt(3)+sqrt(2)]/2",true],
	11: ["还不错嘛，不过接下来会更难了。",_D1,_D4.div(3),"4/3",true],
	12: ["真正的无限!",_D1,new Decimal(Infinity),"Infinity",false],
	13: ["你一定会喜欢下一关的。",_D1,_D3.sqrt().div(6),"[sqrt(3)]/6",true],
	14: ["我知道一个57258步的解法，但是可惜太长了，这里写不下。",_D1,new Decimal(114514),"114514",false],
	15: ["由于无法插入公式，以后将用 'cbrt()' 代替立方根。",_D1,_D2.cbrt(),"cbrt(2)",true],
	16: ["难道说你真的是甜菜！",_D1,_D1.div(65535),"1/65535",true],
	17: ["来！",_D1,_D4.cbrt().add(_D2.cbrt().mul(2)),"cbrt(4)+2cbrt(2)",true],
	18: ["相似，而有所不同。",_D1,_D4.cbrt().sub(_D2.cbrt()),"cbrt(4)-cbrt(2)",true],
	19: ["到此你解锁了所有按钮啦！第20关后的每一关都会把其中一个按钮上的墨迹擦去。",_D1,_D7.log(2),"log<sub>2</sub>7",true],
	20: ["本boss关其实已经被削弱过一次了……想来一定难不住你。(小明正在处理墨水中...)",_D1,_D3.log(6).mul(_D2.sqrt()),"sqrt(2)log<sub>6</sub>3",true],
	21: ["第21-30关正在制作中",_D1,new Decimal(Infinity),"NaN",true],
}
