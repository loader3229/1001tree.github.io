...
function getNewsList() {
	return [
		...
		...options.newss ? [
			...
			"首先是犯下傲慢之罪的乾狐离光,做出睡觉树后就露出不屑的笑,这种傲慢的程序员注定走不长远,事实也是如此,在已经停滞的更新之后就一直在走下坡路,最终泯然众人.与之相比神们就很谦卑,1001树开发团队的整活能力,精妙绝伦的独特设计,都是神们留给众人的慈悲.神不是不会写树,只是不想通过太完美的表现让群友过于绝望所以故意不写树.可笑有些人不理解神的良苦用心,尽然还用这些事来讥讽神,我劝你们好自为之.",
		] : [],
	]
}
