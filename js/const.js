...
function getGameName(id) {
	let name = {
		...
		404/* 第1000夜 */: ["未完成游戏<br>千夜梦语", "这个游戏目前是棍木", 'p8tx'],
		405: ["未完成游戏", "这个游戏目前是棍木", ''],
...
function getNewsList() {
	return [
		...
		...options.newsn ? [
			...
			"有一個人準備自殺,他先站上了海邊懸崖,用繩子套上自己,服下毒藥,在身上潑滿汽油並點燃,對自己的腦袋開了一槍,打偏了,擊中並打斷了他的繩子,使得他墜入海中,水熄滅了火,因為突然的刺激把毒藥吐出來了,數分鐘後他被人發現並送往醫院,最終他因為海水太冷凍死了",
