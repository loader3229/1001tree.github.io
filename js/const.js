...
function getGameName(id) {
	let name = {
		...
		503: ["AIRWAVES", "完全抄袭于DELTARUNE", 'c3'],
		504: ["网格拼图", "这也是解谜?!", 'c3'],
...
//信息，行数，列数，使用的拼图块，禁用格，中心要求格
const data504 = {
	"color": ["#a51715","#ac195e","#b31dad","#7521b9","#3025bf","#2a6bc5","#aa1745","#b01b92","#8c1fb7","#4724bd","#2850c3","#a7162c","#ae1a78","#a21eb5","#5e22bb","#2735c1"],
	1: ["使用下方给定的两块拼图填满网格!注意有些格子不可填入也无需填入拼图。",5,5,[2,0,1],[101,102,103,104,105,201,205,301,305,401,403,404,405,501,502,503,504,505],[]],
	...
	7: ["拼图板上的这个红圈会是什么呢?(拼图块组已切换)",6,6,[2,1,4],[101,102,103,104,105,106,201,202,206,301,306,401,402,406,501,505,506,601,602,603,604,605,606],[303]],
	8: ["测试已完成",10,10,[1,1],[],[]]
}
