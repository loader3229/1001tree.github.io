...
const data402 = {
	0: ["看来出了点问题啊，你不应该看到这段文本的——请反馈给开发者。",_D0,new Decimal(Infinity),"Infinity",false],
	...
	8: ["这是什么！？",_D0,new Decimal(Infinity),"NaN",false],
	9: ["你可以达成黄金比例了！另外，你将在第10,20关分别获得 1 额外梦力。",_D0,_D5.sqrt().sub(1).div(2),"[sqrt(5)-1]/2",true],
	10: ["恭喜迎来第一个boss关！",_D0,_D3.sqrt().add(Math.SQRT2).div(2),"[sqrt(3)+sqrt(2)]/2",true],
	...
	24: ["其实，这里数值的判定机制可以容纳1e-9以内的误差———利用这一点完成本关。",_D2,new Decimal(Math.E),"e ≈ 2.718281828459",false],
	25: ["这里是最后一关了。",_D0,new Decimal(Math.SQRT2).add(_D3.sqrt()).add(_D5.sqrt()),"sqrt(2)+sqrt(3)+sqrt(5)",true],
	26: ["恭喜通关！",_D0,new Decimal(Infinity),"恭喜通关！",false]
}
