...
function getSloganList() {
    return [
        ...
        "I fucked 100 people!",
        `<button onclick="playsound('s2')">1</button><button onclick="playsound('s2')">1</button><button onclick="playsound('s2')">4</button><button onclick="playsound('s2')">5</button><button onclick="playsound('s2')">1</button><button onclick="playsound('s2')">4</button>`,
